...
export default function EventSubCard({event, onUnsub}) {
    ...
    return (
        <article
            className="group relative overflow-hidden rounded-2xl bg-white ring-1 ring-neutral-200 shadow-[0_6px_24px_rgba(0,0,0,0.12)] transition hover:-translate-y-0.5 hover:shadow-[0_10px_28px_rgba(0,0,0,0.14)]">
